...
RULES = [
    ...
    FuzzyRule('R4', [(_NR, 'Normal'),  (_PR, 'Fuerte')],      Operator.AND, 'Amarilla'),
    FuzzyRule('R5', [(_NR, 'Alerta'),  (_PR, 'Seco')],        Operator.AND, 'Preventiva'),
    FuzzyRule('R6', [(_NR, 'Alerta'),  (_PR, 'Moderado')],    Operator.AND, 'Amarilla'),
    FuzzyRule('R7', [(_NR, 'Alerta'),  (_PR, 'Fuerte')],      Operator.AND, 'Roja'),
    FuzzyRule('R8', [(_NR, 'Crítico'), (_PR, 'Fuerte')],      Operator.OR,  'Roja'),
